...
import com.example.corenetwork.external.restring.MemoryStringRepository;
 ...
 * it's not ThreadSafe.
 */
class SharedPrefStringRepository implements com.example.corenetwork.external.restring.StringRepository {
    private static final String SHARED_PREF_NAME = "Restrings";

    private SharedPreferences sharedPreferences;
    private com.example.corenetwork.external.restring.StringRepository memoryStringRepository = new com.example.corenetwork.external.restring.MemoryStringRepository();
