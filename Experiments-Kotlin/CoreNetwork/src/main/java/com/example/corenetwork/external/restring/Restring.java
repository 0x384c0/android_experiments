...
public abstract class Restring {
    ...
    /**
     * Wraps context of an resources to provide Restring features.
     *
     * @param resources context of an activity.
     * @return the RestringResources wrapped context.
     */
    public static RestringResources wrapResources(Resources resources) {
        return new RestringResources(resources,stringRepository);
    }
