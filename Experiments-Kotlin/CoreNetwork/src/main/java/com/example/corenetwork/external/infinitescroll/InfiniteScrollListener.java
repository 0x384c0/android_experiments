 ...
 */
package com.example.corenetwork.external.infinitescroll;
...
public abstract class InfiniteScrollListener extends RecyclerView.OnScrollListener {
    ...
    private boolean canLoadMoreItems() {
        ...
        final int lastItemPosition = visibleItemsCount + pastVisibleItemsCount;
        final boolean lastItemShown = lastItemPosition >= totalItemsCount - itemCountBeforeLoadMore;
