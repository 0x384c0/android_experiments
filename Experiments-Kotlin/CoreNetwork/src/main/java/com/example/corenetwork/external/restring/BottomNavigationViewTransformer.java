 ...
 */
class BottomNavigationViewTransformer implements com.example.corenetwork.external.restring.ViewTransformerManager.Transformer {
    ...
    public View transform(View view, AttributeSet attrs) {
        ...
        Resources resources = ViewTransformerManager.getResources(view);
