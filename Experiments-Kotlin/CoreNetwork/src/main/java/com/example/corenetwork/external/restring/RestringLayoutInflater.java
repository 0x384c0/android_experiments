...
class RestringLayoutInflater extends LayoutInflater {
    ...
    private void setPrivateFactoryInternal() {
        ...
        final Method setPrivateFactoryMethod = com.example.corenetwork.external.restring.ReflectionUtils
        ...
        if (setPrivateFactoryMethod != null) {
            ...
            com.example.corenetwork.external.restring.ReflectionUtils.invokeMethod(
                    this,
    ...
    private View createCustomViewInternal(View parent, View view, String name, Context viewContext, AttributeSet attrs) {
        ...
        if (view == null && name.indexOf('.') > -1) {
            if (mConstructorArgs == null)
                mConstructorArgs = com.example.corenetwork.external.restring.ReflectionUtils.getField(LayoutInflater.class, "mConstructorArgs");

            final Object[] mConstructorArgsArr = (Object[]) com.example.corenetwork.external.restring.ReflectionUtils.getValue(mConstructorArgs, this);
            ...
            com.example.corenetwork.external.restring.ReflectionUtils.setValue(mConstructorArgs, this, mConstructorArgsArr);
            try {
