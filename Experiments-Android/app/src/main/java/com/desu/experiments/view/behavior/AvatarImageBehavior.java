...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<ImageView> {
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent,/*CircleImageView*/ ImageView child, View dependency) {
        return dependency instanceof Toolbar;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent,/*CircleImageView*/ ImageView child, View dependency) {
